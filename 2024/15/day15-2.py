...
from WideWarehouse import Warehouse
...
class TestTopography(unittest.TestCase):
    ...
    def test_gps_coordinates_1(self):
        ...
        self.assertEqual(gps_sum, 9021)

    def test_gps_coordinates_2(self):
        gps_sum = data_from_file('example-2.txt', analyze_warehouse)
        self.assertEqual(gps_sum, 1751)

    def test_gps_coordinates_3(self):
        gps_sum = data_from_file('example-3.txt', analyze_warehouse)
        self.assertEqual(gps_sum, 618)
