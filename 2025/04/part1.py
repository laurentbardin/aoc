...
def main():
    ...
    free_rolls = data_from_file(filename, count_free_rolls)
    print(f"Number of free rolls of paper: {free_rolls}")
...
class TestInvalidIDs(unittest.TestCase):
    def test_invalid_ids(self):
        free_rolls = data_from_file('example.txt', count_free_rolls)
        self.assertEqual(free_rolls, 13)
